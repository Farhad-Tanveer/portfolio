          ...
          <div className="card lg:card-side bg-base-100 mt-20">
            ...
            <div className="card-body lg:w-1/2 ml-24">
              ...
              <div className="flex gap-3 mb-7">
                <button className=" btn btn-sm normal-case">JavaScript</button>
                <button className=" btn btn-sm normal-case">ReactJs</button>
                <button className=" btn btn-sm normal-case">MongoDB</button>
                <button className=" btn btn-sm normal-case">ExpressJs</button>
                <button className=" btn btn-sm normal-case">NodeJs</button>
              </div>
          ...
          <div className="card lg:card-side bg-base-100 mt-20">
            ...
            <div className="card-body lg:w-1/2 ml-24">
              ...
              <div className="flex gap-3 mb-7">
                <button className=" btn btn-sm normal-case">JavaScript</button>
                <button className=" btn btn-sm normal-case">ReactJs</button>
                <button className=" btn btn-sm normal-case">Tailwind</button>
                <button className=" btn btn-sm normal-case">HTML5</button>
                <button className=" btn btn-sm normal-case">CSS</button>
              </div>
              <div className="flex gap-3">
                <button className=" btn normal-case">
                  <a
